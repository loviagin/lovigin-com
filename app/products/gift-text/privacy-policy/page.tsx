...
export const metadata: Metadata = {
    title: 'All Banks Privacy Policy | LOVIGIN LTD',
    description: 'Privacy policy for All Banks - Manage Accounts | LOVIGIN LTD',
};

export default function PrivacyPolicyAllBanks() {
    return (
        <main className={styles.container}>
            ...
            <div className={styles.headerSection}>
                <div className={styles.content}>
                    <h1 className={styles.title}>Privacy Policy All Banks - Manage Accounts</h1>
                    <p className={styles.effectiveDate}><strong>Effective date:</strong> 28 April 2025</p>
                </div>
            </div>
            <div className={styles.content}>
