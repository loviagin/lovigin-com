...
export default function ProductContent() {
    ...
    const product = {
        ...
        longDescription: 'Learn new skills and share your knowledge',
        image: '/projects/learnsy/fav.webp',
        screenshots: [
        ...
        color: '#FF6B6B',
        links: {
            appStore: 'https://apps.apple.com/us/app/learnsy-grow-new-skills/id6502553074'
        }
    };
